import { Building2, Mail, Lock, ArrowLeft, ArrowRight, Shield, Eye, EyeOff, CheckCircle2 } from 'lucide-react';
...
const StepBasicClinic = ({ data, setData, next, back }) => {
        ...
        <div className="w-full flex flex-col md:flex-row m-0 p-0 h-screen">
          ...
          <div className="hidden md:flex md:w-2/5 relative overflow-hidden m-0">
            ...
            <div
              ...
              style={{
                backgroundImage: 'linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.7)), url("/src/assets/images/signUpC.jpg")',
            ...
            <div className="relative z-10 w-full h-full flex flex-col p-6 md:p-8 lg:p-12">
              ...
              <div className="flex-1 flex flex-col justify-center items-center text-center px-4 mt-39">
                <div className="w-full max-w-2xl">
                  <h2 className="text-4xl font-semibold text-white mb-6">Your Clinic, Our Priority</h2>
                  <p className="text-blue-100 text-lg mb-8 leading-relaxed">
                    Join thousands of clinics that trust MediFlow for seamless healthcare management.
                ...
                <div className="w-full mt-6">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
                    <div className="p-6 bg-white/5 rounded-xl backdrop-blur-sm border border-white/5 hover:border-blue-500/30 transition-all duration-300">
                      <div className="text-3xl font-bold text-blue-400 mb-2">99.9%</div>
                      <div className="text-sm font-medium text-gray-300">Uptime</div>
                      <p className="mt-2 text-xs text-gray-400">Reliable service you can trust for your practice</p>
                    </div>
                    
                    <div className="p-6 bg-white/5 rounded-xl backdrop-blur-sm border border-white/5 hover:border-cyan-500/30 transition-all duration-300">
                      <div className="text-3xl font-bold text-cyan-400 mb-2">5,00+</div>
                      <div className="text-sm font-medium text-gray-300">Clinics</div>
                      <p className="mt-2 text-xs text-gray-400">Trusted by healthcare professionals</p>
                    </div>
                    
                    <div className="p-6 bg-white/5 rounded-xl backdrop-blur-sm border border-white/5 hover:border-green-500/30 transition-all duration-300">
                      <div className="text-3xl font-bold text-green-400 mb-2">24/7</div>
                      <div className="text-sm font-medium text-gray-300">Support</div>
                      <p className="mt-2 text-xs text-gray-400">Dedicated assistance when you need it</p>
                    </div>
                  </div>
                </div>
              ...
              <motion.div className="space-y-6 -mt-3" variants={containerVariants}>
                <motion.div className="space-y-2 -ml-15" variants={itemVariants}>
                  ...
                  <motion.p className="text-gray-400 text-sm" variants={itemVariants}>
                    Please fill this details to continue
                  </motion.p>
                </motion.div>
                ...
                <motion.div className="space-y-5" variants={containerVariants}>
                  ...
                  <motion.div className="relative group" variants={itemVariants}>
                    ...
                    <input
                      ...
                      className="w-full pl-16 pr-16 py-4 bg-white/5 border border-white/10 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:border-blue-500 focus:bg-white/5 transition-all text-base"
                      required
                    />
                    <button
                      type="button"
                  ...
                  {/* Terms and Conditions & Sign In Link */}
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start space-x-3">
                        ...
                        <label htmlFor="terms" className="text-sm text-gray-400">
                          I agree to the{' '}
                          <a href="/terms" className="text-blue-400 hover:text-cyan-300 hover:underline">
                            Terms & Conditions
                          </a>{' '}
                          and{' '}
                          <a href="/privacy" className="text-blue-400 hover:text-cyan-300 hover:underline">
                            Privacy Policy
                          </a>
                        </label>
                      </div>
                  ...
                  {/* Navigation Buttons */}
                  <motion.div className="flex flex-col sm:flex-row justify-between items-center gap-4 pt-2" variants={itemVariants}>
                    <button
                      type="button"
                      onClick={back}
...
export default StepBasicClinic;